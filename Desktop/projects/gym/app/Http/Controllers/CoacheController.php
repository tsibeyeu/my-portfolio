    ...
    function index()   {
     ...
     function store(Request $request) {
        $coache=new Coache();
         ...
         $coache->save();
        return redirect()->route('coache.index')->with(['success'=> 'Coache created  successfully.']);
     ...
     function update(Request $request) {
        ...
        $coache->save();
        $coaches=Coache::all();
        return redirect()->route('coache.index')->with(['success'=> 'Coache updated  successfully.']);
     ...
     function destroy(Request $request) {
        ...
        $coache->delete();
        $coaches=Coache::all();
        return redirect()->route('coache.index')->with(['success'=> 'Coache deleted  successfully.']);
