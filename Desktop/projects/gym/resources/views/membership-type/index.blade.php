    ...
    <tbody>
        ...
        <tr>
            ...
            <td> <form action="{{route('membershipType.destroy')}}" method="POST">
                ...
                @method('DELETE')
                <input type="hidden" name="membershipType_id" value="{{$membershipType->id}}"/>
                <button  onclick="return confirm('Are you sure you want to delete this Membership type?')"  type="submit"class="btn btn-danger btn-sm delete btn-flat"><i class='fa fa-trash'></</button>
            </form>
            </td>
